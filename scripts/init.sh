...
set -e
# ==========================================
# Мониторинг интерфейсов vnStat (демон)
# ==========================================
...
command=$ROOT_DIR/scripts/vnstat_monitor.sh
directory=$ROOT_DIR/scripts
autostart=true
autorestart=true
startretries=3
startsecs=5
stdout_logfile=$LOGS_DIR/vnstat_monitor.stdout.log
stderr_logfile=$LOGS_DIR/vnstat_monitor.stderr.log
stdout_logfile_maxbytes=10MB
stderr_logfile_maxbytes=10MB
stdout_logfile_backups=5
stderr_logfile_backups=5
EOF
echo -e "${GREEN}✅ Мониторинг интерфейсов добавлен в Supervisor.${RESET}"
# ==========================================
# Завершение
# ==========================================
echo -e "${GREEN}========================================${RESET}"
